    ...
    return{
        ...
        zoom: function(){
            ...
            if (window.outerWidth < 720){
                document.querySelector(".size").children[0].style.display = 'none';
                document.querySelector(".color").children[0].style.display = 'none';
            } else{
                document.querySelector(".size").children[0].style.display = 'inline';
                document.querySelector(".color").children[0].style.display = 'inline';
            }

            if (window.outerWidth < window.outerHeight){
                document.querySelector(".file-section").style.display = 'none';
                document.querySelector(".edit-section").style.width = '100vw';
            } else{
                document.querySelector(".file-section").style.display = 'flex';
                document.querySelector(".edit-section").style.width = '75vw';
            }
